	...
	<div id="ccm-formBlockPane-add" class="ccm-formBlockPane" style=" <?php  echo (intval($miniSurveyInfo['bID'])==0)?'display:block':''?> ">
		...
		<fieldset id="newQuestionBox">
			...
			<div id="answerReplyto">
				<div class="clearfix">
					<?php echo $form->label('replyto', t('Reply to Email'))?>
					<div class="input">
						<ul class="inputs-list" id="replyto">
							<li><label>
								<?php echo $form->radio('replyto', 1)?>
								<span><?php echo t('Yes')?></span>
							</label></li>
							<li><label>
								<?php echo $form->radio('replyto', 0)?>
								<span><?php echo t('No')?></span>
							</label></li>
						</ul>
					</div>
		...
		<div id="editQuestionForm" style="display:none">
			<fieldset>
				...
				<div id="answerReplytoEdit">
					<div class="clearfix">
						<?php echo $form->label('replytoEdit', t('Reply to Email'))?>
						<div class="input">
							<ul class="inputs-list" id="replytoEdit">
								<li><label>
									<?php echo $form->radio('replytoEdit', 1)?>
									<span><?php echo t('Yes')?></span>
								</label></li>
								<li><label>
									<?php echo $form->radio('replytoEdit', 0)?>
									<span><?php echo t('No')?></span>
								</label></li>
							</ul>
						</div>
